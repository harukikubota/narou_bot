defmodule NarouBot.RichMenu.TopMenu do
  use NarouBot.RichMenu
  ...
  def data() do
    %{
      ...
      areas: [
        ...
        areas(x: 833,  y: 843, w: 833, h: 843, action: %Action.URI{uri: Application.fetch_env!(:narou_bot, :inquery_form_url)}),
