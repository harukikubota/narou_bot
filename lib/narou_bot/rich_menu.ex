defmodule NarouBot.RichMenu do
  alias NarouBot.Repo.RichMenus, as: Repo
  ...
  defmacro __using__(_) do
    quote do
      ...
      alias NarouBot.Template.Helper, as: H
  ...
  defp concat(mod), do: Module.concat(NarouBot.RichMenu, mod)
end
